...
namespace DungeonBlade.UI
{
    ...
    /// <remarks>BankNPC has been moved to its own file (BankNPC.cs) so prefab
    /// YAML script references resolve cleanly. This stub is kept only as a
    /// breadcrumb for anyone searching for the class in this file.</remarks>
}
